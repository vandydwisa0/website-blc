     ...
     <div class="px-4 py-4 overflow-x-auto">
         <table id="table-to-print" class="w-full text-xs text-left text-gray-500 ">
             <thead class="text-xs text-gray-700 uppercase bg-gray-50  ">
                 <tr>
                     <th scope="col" class="px-2 text-center">No</th>
                     <th scope="col" class="px-2 text-center">Nama</th>
                     <th scope="col" class="px-2 text-center">NIS BLC</th>
                     <th scope="col" class="px-2 text-center">Kelas</th>
                     <th scope="col" class="px-2 text-center">No Resi</th>
                     <th scope="col" class="px-2 text-center">Nominal</th>
                     <th scope="col" class="px-2 text-center">Dicount</th>
                     <th scope="col" class="px-2 text-center">Jumlah</th>
                     <th scope="col" class="px-2 text-center">Tipe</th>
                     <th scope="col" class="px-2 text-center">Sisa</th>
                     <th scope="col" class="px-2 text-center">Status</th>
                     <th scope="col" class="px-2 text-center">Tanggal</th>
                     <th scope="col" class="px-2 text-center">Operator</th>
                 ...
                 @foreach ($snapshot as $item)
                     @if ($item->data()['paymentType'] == 'Pendaftaran')
                         <tr class="border-b ">
                             ...
                             {{-- <td class="px-1 py-3">{{ $item->data()['yearPaid'] }}</td> --}}
                         </tr>
                     @endif
                 @endforeach
             </tbody>
