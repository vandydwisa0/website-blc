    ...
    <div class="p-6 space-y-6">
        @foreach ($snapshot as $item)
            <form id="edit">
                ...
                {{-- <div class="flex flex-row items-end pb-7 mt-10 "> --}}
                {{-- <div class="flex flex-row"> --}}
                <div class="flex flex-col justify-end items-end pb-7 mt-10 space-y-4 md:space-y-5 drop-shadow-sm">
                    <p class="text-gray-900 font-semibold text-2xl">Terima Kasih {{ $item->data()['operatorName'] }}
                    </p>
                    {{-- <p class="text-gray-900 font-light text-4xl"> </p> --}}
                    {{-- <p class="mr-20 text-gray-900 font-light text-2xl">{{ $item->data()['operatorName'] }}</p> --}}
                </div>
                {{-- </div> --}}
                {{-- </div> --}}
            </form>
