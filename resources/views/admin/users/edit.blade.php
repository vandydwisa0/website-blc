<div class="block space-y-4 md:flex md:space-y-0 md:space-x-4">
    ...
    <form action="/admin/users/{{ $item->id() }}/edit/" class="badge bg warning">
        @method('edit')
        @csrf
        <button data-modal-target="edit-users{{ $item->id() }}" id="button-edit"
            data-modal-toggle="edit-users{{ $item->id() }}" class="px-2 py-2" type="button">
...
<!-- Main Modal -->
<div id="edit-users{{ $item->id() }}" tabindex="-1" data-modal-backdrop="static" data-te-keyboard="false"
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t ">
                ...
                <button type="button" onclick="reset()"
                    ...
                    data-modal-hide="edit-users{{ $item->id() }}">
            ...
            <div class="p-6 space-y-6">
                <form action="/admin/users/{{ $item->id() }}" id="edit" method="POST">
                    @method('put')
                    @csrf
