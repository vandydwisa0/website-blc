<div class="block space-y-4 md:flex md:space-y-0 md:space-x-4">
    <!-- Modal toggle -->
    <button data-modal-target="tambah-program" data-modal-toggle="tambah-program" type="submit"
...
<!-- Main Modal -->
<div id="tambah-program" tabindex="-1" data-modal-backdrop="static" data-te-keyboard="false"
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t ">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-program">
