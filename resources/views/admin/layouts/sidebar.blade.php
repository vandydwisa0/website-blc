<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2">
            ...
            {{-- @auth('firebase_auth')
                @if (auth('firebase_auth')->user()->role === 'Manager' || auth('firebase_auth')->user()->role === 'Director')
                    <li>
            ...
            {{ request()->is('admin/kelas') ? 'bg-green-300 text-black' : '' }}">
                    <box-icon type='solid' name='collection'></box-icon>
            ...
            <li>
             ...
             {{ request()->is('admin/pembayaran') ? 'bg-green-300 text-black' : '' }}">
                    <box-icon type='solid' name='blanket'></box-icon>
